(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      ...
      // Modification ici : si index est 0, prenez la dernière image, sinon prenez la précédente
    ...
    nextImage() {
      ...
      // Modification ici : si index est à la fin, prenez la première image, sinon prenez la suivante
